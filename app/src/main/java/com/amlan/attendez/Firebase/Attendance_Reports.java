...
public class Attendance_Reports {
    ...
    String classname;
    String subjName;
    ArrayList<Attendance_Students_List> attendance_students_lists;
    ...
    public Attendance_Reports(String date, String monthOnly, String dateOnly, String classId, String date_and_classID, String classname, String subjName, ArrayList<Attendance_Students_List> attendance_students_lists) {
        this.date = date;
    ...
    public ArrayList<Attendance_Students_List> getAttendance_students_lists() {
        return attendance_students_lists;
    }

    public void setAttendance_students_lists(ArrayList<Attendance_Students_List> attendance_students_lists) {
        this.attendance_students_lists = attendance_students_lists;
    }
}
